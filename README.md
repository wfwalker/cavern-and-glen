...
* [X] swords with different strengths, wear and breakage
...
* [X] implement magic items -- split out the player item collection into three subfolders?
...
Infrastructure:
* [X] better unit tests
* [X] more smaller files
* [ ] better separation of concerns
* [X] replace switch statements on Sector type with Use an Object Lookup Map that holds functions

Fun extras:
* [X] CSS for making 1980's beige monochrome monitor bezel
